...
@Component
public class IRASHeaderInputJobCompletionNotificationListener extends JobExecutionListenerSupport {

	private static final Logger log = LoggerFactory.getLogger(IRASHeaderInputJobCompletionNotificationListener.class);

	private final JdbcTemplate jdbcTemplate;

	@Autowired
	public IRASHeaderInputJobCompletionNotificationListener(JdbcTemplate jdbcTemplate) {

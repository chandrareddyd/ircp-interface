...
@Component
public class IRASDetailsInputJobCompletionNotificationListener extends JobExecutionListenerSupport {

	private static final Logger log = LoggerFactory.getLogger(IRASDetailsInputJobCompletionNotificationListener.class);

	private final JdbcTemplate jdbcTemplate;

	@Autowired
	public IRASDetailsInputJobCompletionNotificationListener(JdbcTemplate jdbcTemplate) {
